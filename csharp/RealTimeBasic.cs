...
namespace MyScript
{
    public partial class MyClass
    {
		...
		public void RealTimeBasicTest ( )
		{
			try
			{
				MessageBox.Show ( "RealTimeBasicTest is working. CurrDir = " + Environment.CurrentDirectory, "RealTimeBasicTest" );
			}
			catch ( Exception e )
			{
		...
		//
		//--------------------------------------------------------------------------------------------
		public void RealTimeBasicInit ( IWealthLabAddOn3 wl )
        {
			InternalLibInit ( wl );
		}
		//____________________________________________________________________________________________
		//
		//--------------------------------------------------------------------------------------------
		public void RealTimeBasic_GetBasicSeries ( int slowEmaSeries, int mainEmaSeries, int upperChannelSeries,
		...
		//--------------------------------------------------------------------------------------------
		public void RealTimeBasic_GetStochSeries ( int stochSlowSeries, int stochFastSeries )
		{
			try
			{
