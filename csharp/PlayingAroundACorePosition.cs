...
namespace MyScript
{
    public partial class MyClass
    {
		...
		/// </summary>
		//--------------------------------------------------------------------------------------------
		public void PlayingAroundACorePositionTest ( )
		{
			try
			{
		...
		//
		//--------------------------------------------------------------------------------------------
		public void PlayingAroundACorePositionInit ( IWealthLabAddOn3 wl )
        {
			InternalLibInit ( wl );
		}
		//____________________________________________________________________________________________
		//
		//--------------------------------------------------------------------------------------------
		public void PlayingAroundACorePosition_GetBasicSeries ( int slowEmaSeries, int mainEmaSeries, int upperChannelSeries,
		...
		//--------------------------------------------------------------------------------------------
		public void PlayingAroundACorePosition_GetStochSeries ( int stochSlowSeries, int stochFastSeries )
		{
			try
			{
